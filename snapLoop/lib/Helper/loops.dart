...
final loops = [
  ...
  Loop(name: "Loop4", numberOfMembers: 500, type: LoopType.EXISTING_LOOP),
  ...
  Loop(name: "Loop13", numberOfMembers: 4, type: LoopType.INACTIVE_LOOP_FAILED),
  Loop(name: "Loop14", numberOfMembers: 7, type: LoopType.INACTIVE_LOOP_FAILED),
  Loop(name: "Loop15", numberOfMembers: 3, type: LoopType.INACTIVE_LOOP_FAILED),
  Loop(
      name: "Loop16",
      numberOfMembers: 8,
