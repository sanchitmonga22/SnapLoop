...
//  EXISTING_LOOP
final loops = [
  Loop(name: "Loop1", numberOfMembers: 5, type: LoopType.EXISTING_LOOP),
  Loop(name: "Loop2", numberOfMembers: 11, type: LoopType.EXISTING_LOOP),
  //Loop(name: "Loop3", numberOfMembers: 100, type: LoopType.EXISTING_LOOP),
  //Loop(name: "Loop4", numberOfMembers: 10, type: LoopType.EXISTING_LOOP),
  ...
  Loop(name: "Loop11", numberOfMembers: 2, type: LoopType.NEW_NOTIFICATION),
